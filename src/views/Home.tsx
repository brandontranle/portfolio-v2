...
export const Home = () => {
    ...
    return (
        ...
        <h1 className="font-barcode text-4xl md:text-5xl lg:text-6xl md:mb-5 mt-auto ml-auto"> Home</h1>
            <p className="mb-3"> <span className="dot"></span> <span className="text-black  dark:text-white  font-bold"> Status: </span> <a href="https://vitametrics.org"> IT Risk @ Grant Thornton (SU25)  </a> </p>
